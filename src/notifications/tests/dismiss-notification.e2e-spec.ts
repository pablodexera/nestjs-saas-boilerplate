...
describe('[NotificationsE2E] PATCH /notifications/:id/dismiss', () => {
  ...
  it('allows user to dismiss their notification', async () => {
  ...
  it('forbids other users from dismissing', async () => {
    expect(notificationId).toBeTruthy();
